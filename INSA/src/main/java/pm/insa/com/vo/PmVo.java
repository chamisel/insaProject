...
public class PmVo {
	...
	public String toString() {
		return "PmVo [sabun=" + sabun + ", join_day=" + join_day + ", retire_day=" + retire_day + ", put_yn=" + put_yn
				+ ", name=" + name + ", reg_no=" + reg_no + ", eng_name=" + eng_name + ", phone=" + phone + ", hp=" + hp
				+ ", carrier=" + carrier + ", pos_gbn_code=" + pos_gbn_code + ", cmp_reg_no=" + cmp_reg_no
				+ ", cmp_reg_image=" + cmp_reg_image + ", sex=" + sex + ", years=" + years + ", email=" + email
				+ ", zip=" + zip + ", addr1=" + addr1 + ", addr2=" + addr2 + ", dept_code=" + dept_code
				...
				+ ", mil_enddate=" + mil_enddate + ", join_type=" + join_type + ", gart_level=" + gart_level
